package ch.makery.eventschool.controller;
...
/**
 * Dialog to edit details of a eventSchool.
 * 
 */
public class EventSchoolAddDialogController {
    ...
    /**
     * Sets the eventSchool to be edited in the dialog.
     *
     * @param eventSchool
     */
